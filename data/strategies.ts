...
export const STRATEGIES: Strategy[] = [
  {
    ...
    longDescription: [
      ...
      "Das Ergebnis: +207% Rendite in 10 Jahren bei einem maximalen Rückgang von nur -6.8%. Der SPI Total Return erzielte im selben Zeitraum rund +108% bei einem maximalen Rückgang von -26.9%. SPI Defensiv liefert also rund doppelt so viel Rendite wie der Schweizer Gesamtmarkt — und das bei einem Viertel des Rückgangs.",
    ],
    kernaussagen: [
      "Der tiefste maximale Rückgang aller Strategien: nur -6.8%.",
      "Rund doppelt so viel Rendite wie der SPI — bei einem Viertel des Rückgangs.",
    ...
    tradesPerYear: "~10",
    performanceNote:
      "Zusätzlicher Vergleich: Ein klassisches 60/40-Portfolio — die sogenannte „ausgewogene“ Strategie, wie sie Schweizer Banken anbieten — hätte im selben Zeitraum ca. +68% Rendite bei ca. -17% Max. Rückgang erzielt. SPI Defensiv bietet dreimal so viel Rendite bei einem Drittel des Risikos.",
    performanceTable: [
...

  {
    ...
    highlight: "Über 3× so viel Rendite wie der SPI: +327% vs +108%",
    pa: "15.2% p.a.",
    total: "+327%",
    benchLabel: "SPI",
    benchTotal: "+108%",
    ...
    kernaussagen: [
      "In 10 Jahren mehr als 3× so viel Rendite wie der SPI — bei einem geringeren maximalen Rückgang (-17% statt -27%).",
    ...
    performanceTable: [
      ...
      { period: "10 Jahre", strat: { return: "+326.9%", pa: "+15.2%", maxDd: "-16.6%" }, bench: { return: "+107.9%", pa: "+7.4%", maxDd: "-26.9%" } },
    ],
    keyFacts: {
